...
<head>
    ...
    <title>Commander Moules frites</title>
    <link rel="stylesheet" href="styles.css">
</head>
<body>

<h1 id="page-title">Commander Moules frites</h1>

<div id="image-container">
    <img src="img/menu3.jpg" alt="Moules frites">
</div>

<form action="traitement_commande_moules_frites.php" method="post">
    <input type="hidden" name="plat" value="Moules frites">
